...
import { BookOpen, Play, Globe, Clock, User, Star, Shield, Award } from 'lucide-react'
      ...
      <div className="min-h-screen bg-slate-50">
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="absolute inset-0" style={{ backgroundColor: primary + '99' }} />
          </div>

          {/* Infos formateur superposées */}
        ...
        <div className="max-w-5xl mx-auto px-4 pt-24 pb-16">
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="text-sm text-slate-400">{courses.length} result{courses.length > 1 ? 's' : ''}</span>
          </div>
          ...
          {courses.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-2xl border border-slate-100">
              ...
              <p className="text-slate-400 text-sm mt-1">Revenez bientot, de nouvelles formations arrivent !</p>
            </div>
          ) : (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.map((course) => (
                <div key={course.id} className="bg-white rounded-2xl border border-slate-100 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group flex flex-col">
        ...
        <footer className="border-t border-slate-200 bg-white py-6">
          <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <p className="text-slate-400 text-xs">
              Plateforme de formation en ligne pour l'Afrique
            </p>
            <Link
