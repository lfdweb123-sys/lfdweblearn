...
const courseSchema = z.object({
  title: z.string().min(5, 'Minimum 5 caracteres'),
  description: z.string().min(20, 'Minimum 20 caracteres'),
  shortDescription: z.string().max(160, 'Maximum 160 caracteres').optional(),
...
export default function NewCoursePage() {
  ...
  const onSubmit = async (data: CourseForm) => {
    ...
    try {
      ...
      toast.success('Formation creee ! Ajoutez vos modules.')
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6">
          ...
          <div
            className={cn(
              ...
              thumbnail ? 'border-sky-200 bg-sky-50' : 'border-slate-200 hover:border-sky-300 hover:bg-sky-50'
            )}
          ...
          >
            {thumbnailUploading ? (
              ...
              <div className="relative inline-block">
                <img src={thumbnail} alt="Thumbnail" className="w-48 h-28 object-cover rounded-lg mx-auto" />
                <button
                  type="button"
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <p className="text-sm text-slate-500">Cliquez pour uploader une image</p>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 p-6 space-y-4">
          ...
          <div>
            ...
            <input
              {...register('title')}
              placeholder="Ex: Maitriser React en 30 jours"
              className={cn(
          ...
          <div>
            ...
            <input
              ...
              placeholder="Resume en une phrase..."
              maxLength={160}
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              placeholder="Decrivez votre formation en detail..."
              className={cn(
          ...
          <div className="flex gap-3">
            <button
              ...
              className={cn(
                ...
                !isFree ? 'bg-sky-600 text-white border-sky-600' : 'bg-white text-slate-600 border-slate-200 hover:border-sky-300'
              )}
            >
              Payant
            </button>
            <button
              ...
              className={cn(
                'flex-1 py-3 rounded-xl border text-sm font-medium transition-all',
                isFree ? 'bg-green-600 text-white border-green-600' : 'bg-white text-slate-600 border-slate-200 hover:border-green-300'
              )}
            >
              Gratuit
            </button>
