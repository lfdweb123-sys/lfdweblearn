...
import {
  BookOpen, Shield, Zap, Globe, Users, Star,
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((f) => (
                    <li key={f} className="flex items-center gap-2.5 text-sm">
                      ...
                      <span className={plan.featured ? 'text-sky-100' : 'text-slate-600'}>{f}</span>
                    </li>
                  ))}
                </ul>
                <Link
...
const FEATURES = [
  {
    ...
    description: 'Vidéos, PDFs, audios, images. Organisez en modules et leçons avec une interface intuitive et simple.',
...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Toutes vos vidéos sont streamées via Bunny.net avec des tokens signés et un filigrane dynamique. Il est impossible de les télécharger directement.',
  },
  {
